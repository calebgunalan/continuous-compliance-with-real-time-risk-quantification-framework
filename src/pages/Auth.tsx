...
const Auth = () => {
  ...
  return (
    <div className="min-h-screen bg-background flex flex-col items-center justify-center p-4">
      ...
      {/* Auth Card */}
      <Card className="w-full max-w-md border-border/50 bg-card/80 backdrop-blur-sm animate-slide-up">
        <CardHeader className="text-center pb-2">
          <CardTitle className="text-2xl font-bold">Welcome</CardTitle>
          <CardDescription>
            Sign in to access your organization's compliance dashboard
          </CardDescription>
        </CardHeader>
        <CardContent>
      ...
      <p className="mt-8 text-sm text-muted-foreground animate-fade-in">
        Research participant? Contact your administrator for access.
      </p>
    </div>
  );
};
